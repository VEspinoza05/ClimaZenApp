...
export default function MinicourseProgressView({navigation}) {
    const DATA = [
      ...
      },
      {
        ...
        data: [
          {id: 3, title: 'Como hacer lapicera de cartón', isCompleted: true, },
          {id: 4, title: 'Como hacer carrito de cartón', isCompleted: true, },
          {id: 5, title: 'Como hacer avioncito de cartón', isCompleted: false, },
        ],
      },
    ]
            ...
            <SectionList style={{paddingHorizontal: 20}}
              ListHeaderComponent={() => (
                <View style={styles.listHeader}> 
                  <Image style={styles.picture} source={require('../../assets/carton.jpg')} />
                  <Text style={[secondTitleScreenStyle.secondTitleScreen, styles.homeTitleScreen]}>Curso de manualidades con cartón</Text>
